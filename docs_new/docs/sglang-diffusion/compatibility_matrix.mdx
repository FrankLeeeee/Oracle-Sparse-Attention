      ...
      <table className="sgd-model-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><div className="sgd-id-list"><code>zhuhz22/Causal-Forcing</code> (convert with <code>tools/convert_forcing_to_diffusers.py</code>)</div></td>
            <td>T2V, 480p, chunk-wise / frame-wise 4-step</td>
            <td><span className="sgd-muted">No dedicated optimization listed</span></td>
          </tr>
          <tr>
            <td>Rolling Forcing</td>
            <td><div className="sgd-id-list"><code>TencentARC/RollingForcing</code> (convert with <code>tools/convert_forcing_to_diffusers.py</code>)</div></td>
            <td>T2V streaming long video, 480p, 5-step rolling window</td>
            <td><span className="sgd-muted">No dedicated optimization listed</span></td>
          </tr>
          <tr>
            <td>minWM Causal HunyuanVideo 1.5</td>
            <td><div className="sgd-id-list"><code>MIN-Lab/minWM</code> HY15/TI2V (assemble with <code>tools/assemble_minwm_hy15.py</code>)</div></td>
            <td>TI2V autoregressive, 480p, 4-latent-frame chunks, 4-step</td>
            <td><span className="sgd-muted">No dedicated optimization listed</span></td>
          </tr>
          <tr>
            <td>HunyuanVideo</td>
